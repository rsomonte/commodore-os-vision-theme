...
as_reflection = true
as_ground_color1 = #2c49c6cc
as_ground_color2 = #0016b500
...
as_run_command_screenshot_key = <Shift>Print
...
as_firststart = true
as_background = /usr/share/themes/CommodoreOS/tweaks/CommodoreNeonLogoSmall.png
as_logo = /usr/share/themes/CommodoreOS/tweaks/CommodoreOSVer.png
...
s0_opacity_step = 5
s0_opacity_matches = DropdownMenu & !(state=fullscreen);((type=Normal | Unknown) | name=sun-awt-X11-XFramePeer | name=sun-awt-X11-XDialogPeer) & !(role=toolTipTip | role=qtooltip_label) & !(type=Normal & override_redirect=1) & !(name=gnome-screensaver) & !(state=fullscreen);PopupMenu & !(state=fullscreen);(type=Tooltip | Notification | Utility) & !(name=compiz) & !(title=notify-osd) & !(state=fullscreen);(Dialog | ModalDialog | Normal) & !(state=fullscreen);
s0_opacity_values = 85;92;85;90;90;
...
[ring]
as_next_key = <Control>Tab
as_next_button = Disabled
as_prev_key = <Shift><Control>Tab
as_prev_button = Disabled
...
[core]
as_active_plugins = core;ccp;move;resize;place;decoration;gnomecompat;splash;shelf;water;firepaint;mousepoll;png;imgjpeg;svg;resizeinfo;text;workarounds;session;neg;commands;video;dbus;screenshot;regex;obs;ring;thumbnail;animation;shift;snap;wobbly;animationaddon;fade;cube;rotate;cubeaddon;showmouse;expo;ezoom;3d;scale;kdecompat;scaleaddon;bench;
...
as_mode = 0
as_border_color = #707aee64
as_fill_color = #0b0d331e
as_normal_match = 
as_outline_match = 
as_rectangle_match = 
as_stretch_match = 
...
s0_width = 0.300000
s0_bevel = 0
s0_width_color = #7683ffff
s0_width_color_inactive = #7683ffff
...
[animation]
s0_open_effects = animation:Glide 1;animation:Sidekick;animation:Sidekick;animation:Zoom;
s0_open_durations = 500;300;300;500;
s0_open_matches = ((type=Normal | Unknown) | name=sun-awt-X11-XFramePeer | name=sun-awt-X11-XDialogPeer) & !(role=toolTipTip | role=qtooltip_label) & !(type=Normal & override_redirect=1) & !(name=gnome-screensaver);(type=Menu | DropDownMenu | Dialog | ModalDialog | Normal);(type=Tooltip | Notification | Utility) & !(name=compiz) & !(title=notify-osd);PopupMenu;
s0_open_options = ;;;;
s0_open_random_effects = 
s0_close_effects = animationaddon:Explode;animation:Sidekick;animation:None;animation:Dream;
s0_close_durations = 1000;1000;150;200;
s0_close_matches = ((type=Normal | Unknown) | name=sun-awt-X11-XFramePeer | name=sun-awt-X11-XDialogPeer) & !(role=toolTipTip | role=qtooltip_label) & !(type=Normal & override_redirect=1) & !(name=gnome-screensaver);(type=Menu | DropDownMenu | Dialog | ModalDialog | Normal);(type=Tooltip | Notification | Utility) & !(name=compiz) & !(title=notify-osd);PopupMenu;
s0_close_options = ;;;;
s0_close_random_effects = 
s0_minimize_effects = animationaddon:Burn;
...
s0_hide_all = false
s0_reflection = true
s0_ground_color1 = #3962ffcc
s0_ground_color2 = #0015a800
...
s0_title_font_size = 16
s0_title_back_color = #3246d699
s0_title_font_color = #adcdffff
...
s0_speed = 21.089199
s0_timestep = 49.280300
s0_zoom_factor = 1.595100
...
s0_color = #6e73ffff
s0_scale_image = true
s0_images = /usr/share/themes/CommodoreOS/tweaks/CommodoreNeonLogo.png;
s0_adjust_image = false
s0_skydome = true
s0_skydome_image = /usr/share/themes/CommodoreOS/tweaks/CommodoreCubeWallpaper.jpg
s0_skydome_animated = true
s0_skydome_gradient_start_color = #05156dff
s0_skydome_gradient_end_color = #0a1458ff
...
s0_explode_spokes = 2
s0_explode_tiers = 3
s0_explode_thickness = 6.012300
s0_explode_tessellation = 0
s0_fold_gridx = 3
s0_fold_gridy = 3
s0_fold_dir = 1
s0_glide3_away_position = -0.500000
...
s0_reflection = true
s0_ground_color1 = #5061ffcc
s0_ground_color2 = #3142e100
s0_ground_size = 0.500000
...
s0_top_color = #211cdfff
s0_bottom_color = #1d2ae2ff
s0_top_images = /usr/share/themes/CommodoreOS/tweaks/CommodoreNeonLogo.png;
s0_bottom_images = /usr/share/themes/CommodoreOS/tweaks/CommodoreNeonLogo.png;
...
s0_size = 4.739400
s0_slowdown = 6.157200
s0_life = 0.854900
s0_darken = 0.140500
s0_blend = true
s0_color = #7a8ff9ff
s0_random = false
s0_rotation_speed = 0.100000
s0_radius = 87
s0_emiters = 10
...
as_command6 = 
as_command7 = 
as_command8 = gnome-system-monitor
as_command9 = 
as_command10 = 
as_command11 = 
...
as_run_command8_key = <Control><Alt>Delete
